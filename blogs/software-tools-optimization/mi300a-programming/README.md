...
This blog post will introduce you to the advantages of AMD Instinct&trade; [MI300A][1] accelerated processing unit (APU),
...
We will then show you how AMD [ROCm&trade;][12] enables the APU Programming Model and how to handle its memory allocations.
...
In [MI300A][1] - the AMD ["Zen"][2] [4 EPYC&trade;][3] cores and third generation [CDNA&trade;][4] compute units share the
...
[ROCm&trade;][12] is an open software stack including drivers, development tools, and APIs
...
Many HPC applications also use directive-based approaches with [OpenMP&trade;][33] to parallelize regions of code.
...
Acceleration on AMD Instinct&trade; GPUs is also available through other abstraction layers, like
