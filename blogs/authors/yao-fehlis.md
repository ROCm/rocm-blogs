...
learning to accelerate scientific discoveries. In AI for manufacturing, she works internally with product teams to use machine learning (ML) to uncover optimal parameters and configurations in
AMD designs.
