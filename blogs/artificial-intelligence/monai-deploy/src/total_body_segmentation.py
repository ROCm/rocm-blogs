...
# Required for setting SegmentDescription attributes. Direct import as
# this is not part of App SDK package.
...
class TotalBodySegmentation(Application):
    ...
    def run(self, *args, **kwargs):
        # This method calls the base class to run. Can be omitted if simply
        # calling through.
