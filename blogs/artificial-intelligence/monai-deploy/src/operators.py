...
from monai.deploy.core import DataPath, Image, IOType, Operator
from monai.deploy.operators import NiftiDataLoader
from monai.deploy.operators.monai_seg_inference_operator import (
    InMemImageReader, MonaiSegInferenceOperator)
from monai.networks.nets import SegResNet
from monai.transforms import (Activationsd, AsDiscreted, Compose,
                              EnsureChannelFirstd, Invertd, LoadImaged,
                              NormalizeIntensityd, Orientationd, Resized,
                              SaveImaged, ScaleIntensityd, Spacingd)
...
class SegInferenceOperator(Operator):
    ...
    def compute(self, op_input, op_output, context):
        ...
        # monai.core.model.Model skeleton from app context rather than
        # torch.nn.Module
