...
blog_title: "Pre-training BERT using Hugging Face & TensorFlow on an AMD GPU"
...
myst:
    html_meta:
        "description lang=en": "Pre-training BERT using Hugging Face & Tensorflow on an AMD GPU"
