...
The inference capabilities of ROCm have already demonstrated leadership
performance
([link](https://rocm.blogs.amd.com/artificial-intelligence/LLM_Inference/README.html))
...
**Focus on Training Workloads: Delivering Key Requirements for
End-to-End Training Leadership**

Training state-of-the-art AI models, such as Llama and Mistral, requires
...
optimization for hipBLASLt and FP8 support for inference and training
forward pass using E4M3 format and [E5M2 format for backward
pass]{.mark}. There are several other critical optimizations planned for
imminent support, including Transformer Engine, improved GEMM
heuristics, and the introduction of \"StreamK\" in GEMM libraries and
full
[TunableOps](https://rocm.blogs.amd.com/artificial-intelligence/pytorch-tunableop/README.html)
...
**Performance Highlights: Strong Competitive Training Performance Across
Models, Datatypes & Frameworks**

The latest ROCm enhancements deliver strong competitive performance on
models like Llama, Mistral, and FLUX by leveraging FP8 and BF16 data
...
docker](https://hub.docker.com/r/rocm/pytorch-training).

Learn how to get started with AMD ROCm containers at [ROCm
...
developers to realize the full

the potential of AI innovation.

[Learn more about ROCm](https://rocm.blogs.amd.com).
