...
def process_open_orca(dataset_name, device, tokenizer, seqlen, sample_len):
    ...
    for idx in range(sample_len):
        ...
        input_ids = pad(input_ids, (seqlen - input_length, 0, 0, 0), value=tokenizer.pad_token_id)
...
def get_calib_dataloader_to_list(dataset_name: str = "pileval_for_awq_benchmark",
    ...
    if dataset_name == "pileval_for_awq_benchmark":
        ...
        samples = process_open_orca(dataset_name, device, tokenizer, seqlen, num_calib_data)
...
def get_calib_dataloader(
    ...
    elif dataset_name in ["pileval_for_awq_benchmark", "wikitext_for_gptq_benchmark"] or "open_orca" in dataset_name:
