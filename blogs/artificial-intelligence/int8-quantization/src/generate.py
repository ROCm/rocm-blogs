...
def main(
    ...
    print(f"Average memory bandwidth of last 10 iterations: {torch.mean(torch.tensor(aggregate_metrics['memory_bw'][-10:])).item():.2f}")
    print(f"Std. dev. memory bandwidth of last 10 iterations: {torch.std(torch.tensor(aggregate_metrics['memory_bw'][-10:])).item():.2f}")
